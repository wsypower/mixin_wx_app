    ...
    <div class="step-one-page">
        ...
        <van-form>
            ...
            <van-field name="radio" label="证件类型：">
                <template #input>
                    <my-radio-group :initValue="submitData.fileType" :radioGroup="fileTypeArray" @getRealValue="(name)=>{getRealValue('fileType', name)}"></my-radio-group>
                </template>
            </van-field>
            <van-divider class="mini-line"></van-divider>
            <template v-if="submitData.fileType === '1'">
            ...
            <template v-if="submitData.fileType === '2'">
            ...
            <template v-if="submitData.fileType === '3'">
                <div class="upload-img" flex="dir:left cross:center main:justify">
                    <div class="upload-item">
                        <div class="file-zm_icon"></div>
                        <div class="file-zm_text">拍摄证件照片像面</div>
                ...
                <van-divider></van-divider>
                <van-field v-model="submitData.hzcode" label="护照号：" placeholder="请输入护照号" input-align="right"/>
                <van-divider></van-divider>
